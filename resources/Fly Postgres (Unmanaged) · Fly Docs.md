---
created: 2026-04-22T15:54:30 (UTC +10:00)
tags: [fly,fly.io,documentation,docs,elixir,docker,cdn,hosting,servers,networking,deploy app servers,close to users,postgresql clusters,heroku competitor,heroku alternative]
source: https://fly.io/docs/postgres/
author: 
---

# Fly Postgres (Unmanaged) · Fly Docs

> ## Excerpt
> Documentation and guides from the team at Fly.io.

---
[Docs](https://fly.io/docs/) Fly Postgres (Unmanaged)

![Illustration by Annie Ruygt of a balloon disguised as an elephant](Fly%20Postgres%20(Unmanaged)%20%C2%B7%20Fly%20Docs/postgres.png)
...
**[Read about why Fly Postgres is not the same thing as a managed database service](https://fly.io/docs/postgres/getting-started/what-you-should-know).**
...
You can also add read-only replicas in other regions and take advantage of the Fly.io platform’s proxy features to build a [Globally Distributed Postgres cluster](https://fly.io/docs/postgres/advanced-guides/high-availability-and-global-replication).
